...
# id to name:
# id2name = {label.id: name for name in names}
...
#     _id = 82
#     category = id2label[_id].category
#     print("Category of label with ID '{_id}': {category}".format(_id=_id, category=category))    
#     name = id2label[_id].name
#     print("Name of label with ID '{_id}': {name}".format(_id=_id, name=name))
