...
def click_event(event, x, y, flags, (color, depth1, depth2)):
...
if __name__ == "__main__":
    ...
    depth1 = readDepth(args.depth1) # read depth from dataset
    ...
    cv2.setMouseCallback("Color", click_event, (color, depth1, depth2))
